...
<html>
<head>
  <title>Grazie per il vostro ordine!</title>
  ...
  <div class="content">
    <div class="row">
      ...
      <div class="col-lg-10 col-md-10 col-sm-10 col-xs-12">
        <h2 class="success_page_main_title">Grazie per il vostro ordine!</h2>
        <div class="success_page_top_message">Un nostro operatore vi contatterà entro un giorno lavorativo.</div>
        <h3 class="success_page_bottom_message">Prego, accendere il telefono.</h3>
        <div class="order_info_wrap">
          <ul class="order_info_item_wrap">
            <li class="order_info_item">
              <span class="order_info_item_value">Nome: </span>
              <span id="name"></span>
            </li>
            <li class="order_info_item">
              <span class="order_info_item_value">Telefono: </span>
              <span id="phone"></span>
            </li>
          </ul>
        </div>
